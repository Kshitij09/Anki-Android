...
class FieldEditLine : FrameLayout {
    ...
    private fun init() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            if (editText != null && toggleSticky != null && mediaButton != null && mExpandButton != null) {
                ...
                constraintSet.connect(toggleSticky!!.id, ConstraintSet.END, mediaButton!!.id, ConstraintSet.START)
                constraintSet.connect(mediaButton!!.id, ConstraintSet.END, mExpandButton!!.id, ConstraintSet.START)
